...
const SIGNAL_ROUNDS = [
  ...
  {
    prompt: 'Из Kronos утекли три голосовых сэмпла. Какой в среднем расскажет больше всего о говорящем?',
    options: [
      ...
      { label: 'Голос δ', detail: '4 буквы · равномерно', probs: [0.25, 0.25, 0.25, 0.25], why: '2 бит на знак. Максимальная плотность информации.', best: true },
    ],
  },
  {
        ...
        <div style={{flex: '1 1 380px', minWidth: 320}}>
          <div className="panel">
            ...
            <div className="row mt-4">
              ...
              <button className="btn ghost" onClick={skew} style={{padding:'6px 12px', fontSize:11}}>скос</button>
            </div>
          </div>
        </div>
...
function CompressionLab() {
  const samples = [
    ...
    { id: 'msg', label: 'перехват/смс',     text: 'встреча у причала 9 принеси чип не опаздывай' },
    ...
    <div>
      ...
      <div className="brackets panel" style={{maxWidth: 920}}>
        ...
        <div className="body" style={{lineHeight: 1.7, marginTop: 12}}>
          <p>
            До этого захода я думал, что «информация» — то же самое, что «содержимое»: вес фразы,
            ...
            и не сообщать ничего, потому что следующий символ уже известен. Одна строка, которая тебя
            удивит, может стоить мегабайта успокоительной телеметрии.
          </p>
          <p>
          ...
          <p>
            ...
            космосвязь) добавляет избыточности обратно — ровно столько, чтобы пережить шумный провод;
            ...
            по построению низкоэнтропичен и кажется человечным; «перплексия» — это просто{' '}
            <span className="mono">2^H</span> в красивой шляпе. <b style={{color:'var(--neon-pink)'}}>Big Data</b>{' '}
          ...
          <p style={{color: 'var(--ink-dim)'}}>
            Вывод нетраннера: когда пытаешься понять, что именно слушать в шумном городе, не меряй
            громкость канала. Меряй, насколько он бы тебя удивил. Самые громкие билборды Неон-Харбора,
